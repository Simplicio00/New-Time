...
namespace TW.Repositorios
{
    public class UsuarioRepositorio : IUsuarioRepositorio
    {
        ...
        public async Task<Usuario> PostUserName(Usuario usuario)
        {
            Usuario usuarioRetornado = await context.Usuario.Where(x => x.NomeCompleto == usuario.NomeCompleto).FirstOrDefaultAsync();
            await context.SaveChangesAsync();
            return usuarioRetornado;
        }
